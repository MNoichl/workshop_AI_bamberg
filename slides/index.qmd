...
* *In-Context Watermarks for Large Language Models*: peer review is one motivating use case. [OPEN PAPER](#){.opens-modal data-modal-type="iframe" data-modal-url="images/7815_In_Context_Watermarks_for.pdf"}
...
::: aside
[@liuInContextWatermarksLarge2026]
:::
...
* Maybe a future in review pipelines.
* [EXERCISE]{.gp-exercise-tag} Review a draft or paper.

::: aside
[@gaoNonstandardErrorsAIAgents2026]
:::
