...
* ARC-style benchmarks try to test abstract reasoning on tasks that are easy for humans but hard for AI. [OPEN TASK](#){.opens-modal data-modal-type="iframe" data-modal-url="https://arcprize.org/tasks/135a2760/"}
...
* **MCP-servers:** Provide tools to LLMs iin a uniform format.
...
* Or do we already prefer AI? [NYT](#){.opens-modal data-modal-type="iframe" data-modal-url="https://www.nytimes.com/interactive/2026/03/09/business/ai-writing-quiz.html"} [Econ](#){.opens-modal data-modal-type="iframe" data-modal-url="https://kevin-kloiber.com/choose-your-side.html"}
...
* Run experiments, or ABMs with AIs instead of humans participants. [OPEN PAPER](#){.opens-modal data-modal-type="iframe" data-modal-url="images/in_silico.pdf"}
* Very controversial.
